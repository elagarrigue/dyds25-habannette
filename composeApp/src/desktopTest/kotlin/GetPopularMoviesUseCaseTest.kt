...
class GetPopularMoviesUseCaseTest{
    ...
    @Test
    fun `getPopularMovies obtiene Movies y las ordena de forma descendente`() = runBlocking {
        //Arrange
        ...
        val repository = object : MoviesRepository {
        ...
        assertEquals(resultado[0].isGoodMovie, true)
        assertEquals(resultado[1].isGoodMovie, false)
        assertEquals(resultado[2].isGoodMovie, true)

    }

    @Test
    fun `getPopularMovies con lista vacia retorna vacio`() = runBlocking {
        val repository = object : MoviesRepository {
